        ...
        <Modal.Body>
          <Form>
            <Form.Group className="mb-3" >
              ...
              <Form.Control onChange={hadleChange}
               name="title" 
               id="title" 
                type="text" 
                autoFocus 
            ...
            >
              ...
              <Form.Control onChange={hadleChange} as="textarea" id="descriptions" name="descriptions" value={n.descriptions} rows={3}  />
            </Form.Group>
          </Form>
        </Modal.Body>
        <Modal.Footer>
          ...
          <Button variant="primary" onClick={handleUpdate} disabled={ n.title.length <3 || n.descriptions.length<3}>
            Save Changes
          </Button>
        </Modal.Footer>
      </Modal>
